...
urlpatterns = [
    ...
    path("campaigns/<int:campaign_id>/chapters/<int:chapter_id>/encounters/<int:encounter_id>/notes/modal/", EncounterNoteModalView.as_view(), name="encounter_note_modal"),
